...
int main(int argc, char **argv)
{
	...
	skel = uprobe_failed_bpf__open_opts(&opts);
	if (!skel) {
	...
	err = uprobe_failed_bpf__load(skel);
	if (err) {
...
cleanup:
	/* Clean up */
	uprobe_failed_bpf__destroy(skel);
